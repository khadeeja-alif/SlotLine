...
namespace SlotLineTest
{
    ...
    {
        public CustomEntry materialEntry { get { return EntryField; } }
        ...
        public static BindableProperty DefaultColorProperty = BindableProperty.Create(nameof(DefaultColor), typeof(Color), typeof(MaterialEntry), Color.FromHex("#d4d4d4"), propertyChanged: (bindable, oldVal, newVal) =>
        {
            var matEntry = (MaterialEntry)bindable;
            matEntry.UpdateValidation();
        });
        public static BindableProperty PlaceholderColorProperty = BindableProperty.Create(nameof(PlaceholderColorProperty), typeof(Color), typeof(MaterialEntry), Color.FromHex("#989898"), propertyChanged: (bindable, oldVal, newVal) =>
        {
            var matEntry = (MaterialEntry)bindable;
        ...
        private async Task CalculateLayoutUnfocused()
        {
            if (IsValid)
            {
                HiddenLabel.TextColor = PlaceholderColor;
                BottomBorder.BackgroundColor = DefaultColor;
            }
